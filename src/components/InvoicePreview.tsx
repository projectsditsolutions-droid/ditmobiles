...
const InvoiceBodyInner: React.FC<{
  ...
  <div className="invoice-page" style={{ fontFamily: 'Inter, Arial, sans-serif', fontSize: '12px', color: '#111', background: '#fff', padding: '0' }}>
    ...
    {(invoice.payment_method === 'emi' || invoice.payment_method === 'mixed') && (
      <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '10px', marginBottom: '12px' }}>
        ...
        {invoice.emi_lending_partner && (
          <div style={{ fontSize: '11px', marginBottom: '6px', padding: '4px 10px', background: '#eef2ff', borderRadius: '6px', display: 'inline-block' }}>
    ...
    {/* Non-mixed, non-EMI: show simple payment mode */}
    {invoice.payment_method !== 'emi' && invoice.payment_method !== 'mixed' && (
      <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '10px', marginBottom: '12px' }}>
